...
namespace Core\Vendor\Yaml\Tests;

use PHPUnit\Framework\TestCase;
use Core\Vendor\Yaml\Parser;
...
EOF;
    ...
    {
        $input = <<<'EOF'
foo: !!php/object:O:30:"Core\Vendor\Yaml\Tests\B":1:{s:1:"b";s:3:"foo";}
bar: 1
EOF;
...
YAML;
    ...
    /**
     * @dataProvider invalidDumpedObjectProvider
     * @expectedException \Core\Vendor\Yaml\Exception\ParseException
     */
    ...
    public function testNonUtf8Exception()
    {
        ...
        foreach ($yamls as $yaml) {
            try {
                ...
                $this->assertInstanceOf('Core\Vendor\Yaml\Exception\ParseException', $e, 'charsets other than UTF-8 are rejected.');
            }
        }
    }
...
EOT
    ...
    public function testParserThrowsExceptionWithCorrectLineNumber($lineNumber, $yaml)
    {
        if (method_exists($this, 'expectException')) {
            $this->expectException('\Core\Vendor\Yaml\Exception\ParseException');
            $this->expectExceptionMessage(sprintf('Unexpected characters near "," at line %d (near "bar: "123",").', $lineNumber));
        } else {
            $this->setExpectedException('\Core\Vendor\Yaml\Exception\ParseException', sprintf('Unexpected characters near "," at line %d (near "bar: "123",").', $lineNumber));
        }
