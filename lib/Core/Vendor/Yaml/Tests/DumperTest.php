...
EOF;
    ...
    public function testObjectSupportEnabled()
    {
        ...
        $this->assertEquals('{ foo: !php/object:O:30:"Core\Vendor\Yaml\Tests\A":1:{s:1:"a";s:3:"foo";}, bar: 1 }', $dump, '->dump() is able to dump objects');
    }
    ...
    /**
     * @expectedException \Core\Vendor\Yaml\Exception\DumpException
     */
